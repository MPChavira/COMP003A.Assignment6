...
{
    /// <summary>
    ///  Abstracts describe a contract but does provide a full implementation of the contract.
    ///  Read https://learn.microsoft.com/en-us/dotnet/standard/design-guidelines/abstractions-abstract-types-and-interfaces
    /// </summary>
    abstract class Vehicle : IVehicle
    {
        /***** fields section *****/
        // note: in almost all programing languages, you would typically pair a field with a property
        ...
        /// <summary>
        /// Constructor that takes three parameters: brand, model, numberOfWheeels
        /// </summary>
